                        ...
                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                            ...
                            ?>
                                <?php $no=1; foreach($tagihan_filter as $tf): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="" class="btn btn-warning btn-sm"><i class="fa fa-print"></i></a>
                            ...
                            <?php $no=1; foreach($tagihan as $t): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="" class="btn btn-warning btn-sm"><i class="fa fa-print"></i></a>
                                        <a href="" data-toggle="modal" data-target="#detailModal<?= $t->id ?>" class="btn btn-warning btn-sm">Detail</a>
                                    </td>
                                </tr>
                            <?php $no++; endforeach; }?>
                            </tbody>
